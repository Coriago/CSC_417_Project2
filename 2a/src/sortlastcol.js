...
function readVals() {
    ...
    //prints the header
    console.log(data[0]);
    var vals = data.slice(1, data.length - 1).map(function (line) { return line.split(",").map(Number); });
    processVals(vals);
}
/**
 ...
 */
function mergeSort(vals, n) {
    if (n === void 0) { n = vals.length; }
 ...
 */
function merge(vals, left, right, leftn, rightn) {
    var i = 0;
    var j = 0;
    var k = 0;
